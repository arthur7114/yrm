...
export default function MessageTimeline({ messages }: { messages: LeadMessage[] }) {
    ...
    if (!messages || messages.length === 0) {
        return (
            <div className="bg-white shadow-sm border border-gray-200 rounded-lg p-12 text-center h-full flex flex-col items-center justify-center">
    ...
    return (
        <div className="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden flex flex-col h-[calc(100vh-8rem)]">
