...
export default function SectionPanel({
    ...
    return (
        <section className={`yrm-panel overflow-hidden rounded-2xl ${className}`.trim()}>
            <header className="flex flex-col gap-4 border-b border-[rgba(183,166,148,0.5)] bg-[var(--yrm-surface-strong)] px-5 py-4 sm:flex-row sm:items-end sm:justify-between sm:px-6">
